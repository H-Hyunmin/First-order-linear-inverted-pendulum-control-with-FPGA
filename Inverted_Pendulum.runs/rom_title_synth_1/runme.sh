...
HD_PWD='D:/VIVADO/homwork3question2/XADC_test/XADC_test.runs/rom_title_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_title.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_title.tcl
